...
function insertarNombre(event){
  ...
  let option = '<li>'+ userName +'</li>';



  // `
  // <li> ${userName}
  //   <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" id="delete" viewBox="0 0 16 16">
...
// ESTO FUCIONA PARA AGREGAR UN USER, PERO AL ADD EL NEXT NO QUEDA GUARDADO EL ANTERIOR
